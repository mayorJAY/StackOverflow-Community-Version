...
public class QuestionViewModelModule {
    ...
    ViewModel bindQuestionViewModel(int page, int pageSize, String order, String sortCondition, String site, String filter, String siteKey, QuestionRepository questionRepository) {
        return new QuestionViewModel(questionRepository, page, pageSize, order, sortCondition, site, filter, siteKey);
    }
}
